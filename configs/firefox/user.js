...
user_pref('geo.provider.network.url','https://location.services.mozilla.com/v1/geolocate?key=%MOZILLA_API_KEY%'); // prettier-ignore
...
user_pref('network.buffer.cache.size', 262144); // 256KB
...
user_pref('privacy.fingerprintingProtection.overrides','+AllTargets,-CSSPrefersColorScheme,-JSDateTimeUTC'); // prettier-ignore
user_pref('privacy.fingerprintingProtection.pbmode', false); // breaks sites and window sizing
user_pref('privacy.fingerprintingProtection', false); // breaks sites and window sizing
user_pref('privacy.globalprivacycontrol.enabled', true);
user_pref('privacy.history.custom', true);
user_pref('privacy.partition.always_partition_third_party_non_cookie_storage.exempt_sessionstorage', false); // prettier-ignore
user_pref('privacy.partition.always_partition_third_party_non_cookie_storage', true);
user_pref('privacy.partition.network_state', true);
user_pref('privacy.partition.serviceWorkers', true);
user_pref('privacy.query_stripping.enabled.pbmode', true);
user_pref('privacy.query_stripping.enabled', true);
user_pref('privacy.query_stripping.strip_list', '__hsfp __hssc __hstc __s _hsenc _openstat dclid fbclid gbraid gclid hsCtaTracking igshid mc_eid ml_subscriber ml_subscriber_hash msclkid oft_c oft_ck oft_d oft_id oft_ids oft_k oft_lk oft_sk oly_anon_id oly_enc_id rb_clickid s_cid twclid vero_conv vero_id wbraid wickedid yclid'); // prettier-ignore
user_pref('privacy.resistFingerprinting.block_mozAddonManager', true);
user_pref('privacy.resistFingerprinting.pbmode', false); // breaks sites and window sizing
user_pref('privacy.resistFingerprinting', false); // breaks sites and window sizing
