# Generated by Powerlevel10k configuration wizard on 2025-11-01 at 04:44 EDT.
...
() {
  ...
  # Allow direnv and other tools to output during instant prompt without warning
  ...
  # Custom icon - show GitHub logo for repos with GitHub remote.
  ...
  # Use bundled gitstatus from jsh (if available)
  # Falls back to system gitstatus if directory not found
  [[ -d "${JSH_DIR}/lib/gitstatus" ]] && typeset -g POWERLEVEL9K_GITSTATUS_DIR="${JSH_DIR}/lib/gitstatus"
